...
@section('content')
    ...
    <div class="row bg-title">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"> Reporte de ventas no conciliadas </h4>
        </div>
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                <li><a href="#">Coordinaci&oacute;n</a></li>
                <li class="active">Reporte de ventas no conciliadas.</li>
            </ol>
        </div>
    </div>
    <div class="row">
            ...
            <div class="white-box">
                <div class="alert alert-info">
                    <p style="font-size: 15px;">
                        Este reporte muestra las ventas hechas por tus vendedores, de las cuales no has recibido el dinero.</b>
                    </p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 p-b-20" id="list-unconc" hidden="">
        ...
        $(function () {
            ...
            function loadList(form = '', action = ''){
                ...
                $.ajax({
                    ...
                    async: true,
                    url: "{{route('coordination.getReportUnConcSales')}}",
                    method: 'POST',
                    ...
                    success: function (res) {
                        ...
                        if(res.success){
                            ...
                            $('#list-unconc').html(res.html);
                            $('#list-unconc').attr('hidden', null);
                    ...
                    error: function (res) {
                        $('.loading-ajax').hide();
                        showMessageAjax('alert-danger', 'No se pudieron cargar las ventas.');
                    }
                });
            }
